...
namespace Restaurants.Infrastructure.Requirements.Tests;
...
public class CreatedMultipleRestaurantsRequirementHandlerTests
{
    ...
    public async void HandleRequirementAsync_UserHasCreatedMultipleRestaurants_ShouldSucceed()
    {
        ...
        var handler = new CreatedMultipleRestaurantsRequirementHandler(restaurantRepoMock.Object, userContextMock.Object);
    ...
    [Fact()]
    public async void HandleRequirementAsync_UserHasNotCreatedMultipleRestaurants_ShouldFail()
    {
        // arrange
